        ...
        <div className='w-full h-screen flex flex-col items-center justify-center overflow-y-scroll bg-gray-800'>
            <div className='bg-gray-200 w-96 h-auto rounded-lg pt-8 pb-8 px-8 flex flex-col items-center'>
                <label className='font-light text-4xl mb-4'>
                    <span className='font-bold'>Invoicer</span>
                </label>
                <input
                ...
                {errors.email && (
                    <div
                        className='bg-red-200 capitalize rounded-md text-center p-2 w-full mb-4 text-sm text-red-700'
                        role='alert'
                    >
                        {errors.email}
                    </div>
            ...
            <p className='text-gray-100 mt-2'>
                ...
                <Link to='/signup'>
                    <a className='text-gray-500'>Signup</a>
                </Link>
            </p>
        </div>
    );
